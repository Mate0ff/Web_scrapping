...
def WebScrapper(num_pages,param) -> None:
    ...
    try:
        ...
        jobs_container = soup.find('div',class_='list-container')

        job_titles = jobs_container.find_all('h3', class_='posting-title__position')
        companies = jobs_container.find_all('h4', class_='company-name')
        salaries = jobs_container.find_all('span', class_='salary')
        skills = jobs_container.find_all('div', class_='tiles-container')
        links = jobs_container.find_all('a', class_='posting-list-item')
